...
// collecting metrics. The expvar package is already based on the singleton
...
// init contsructs the metrics value that will be used to captured metrics
// The metrics value is stored in a package level variable since everything
// inside of expvar is registered as a singleton. The use of the once will make
