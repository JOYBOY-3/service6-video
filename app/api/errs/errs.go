// Package errs provides types and support related to web arroe functionality
package errs
...
// New contructs an error based on an app error.
...
// IsError tests the concrete error is of thr Error type.
