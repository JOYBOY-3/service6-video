...
// GenToken generates a JWT the speccified user
func GenToken() error {
	...
	claims := struct {
		...
		RegisteredClaims: jwt.RegisteredClaims{
			Subject:   "732d55e9-a1fd-4024-91b9-9b520c4281ce",
	...
	// Marshall the public key from the private key to PKIX.
	...
	// Write the public key to public key file.
...
// Genkey create an x509 private/public key for auth tokens.
func Genkey() error {
	...
	// Write the private key to private key file.
	...
	fmt.Println("private and pubic key generated")
